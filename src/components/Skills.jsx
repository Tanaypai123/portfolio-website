...
const logos = {
  ...
  'Express.js': <svg viewBox="0 0 32 32" width="16" height="16"><text x="2" y="22" fontFamily="sans-serif" fontWeight="bold" fontSize="12" fill="#777">EXP</text></svg>,
  ...
  'GitHub': <svg viewBox="0 0 32 32" width="16" height="16"><path d="M16 3C9 3 3 9 3 16c0 5.8 3.8 10.8 9 12.5.7.1.9-.3.9-.6v-2.2c-3.7.8-4.5-1.6-4.5-1.6-.6-1.5-1.5-1.9-1.5-1.9-1.2-.8.1-.8.1-.8 1.3.1 2 1.4 2 1.4 1.2 2 3 1.4 3.8 1.1.1-.8.5-1.4.8-1.7-2.9-.3-6-1.5-6-6.5 0-1.4.5-2.6 1.3-3.5-.1-.3-.6-1.7.1-3.5 0 0 1.1-.3 3.5 1.3 1-.3 2.1-.4 3.2-.4s2.2.1 3.2.4c2.4-1.6 3.5-1.3 3.5-1.3.7 1.8.3 3.2.1 3.5.8.9 1.3 2.1 1.3 3.5 0 5-3.1 6.2-6 6.5.5.4.9 1.2.9 2.4v3.5c0 .3.2.7.9.6C25.2 26.8 29 21.8 29 16 29 9 23 3 16 3z" fill="#111"/></svg>,
  ...
  return (
    <motion.span
      ...
      style={{
        ...
        fontSize: '0.92rem', fontWeight: 550,
...
const categories = [
  {
    label: 'Frontend',
    color: 'var(--accent-dark)', bg: 'var(--accent-dim)', border: 'var(--border-accent)',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>,
    skills: ['HTML', 'CSS', 'JavaScript', 'TypeScript', 'React', 'Tailwind CSS'],
  },
  {
    label: 'Backend',
    color: '#5C6E58', bg: 'rgba(143, 168, 155, 0.12)', border: 'rgba(143, 168, 155, 0.25)',
  ...
  {
    label: 'Database',
    color: '#4B6B5B', bg: 'var(--green-dim)', border: 'rgba(143, 168, 155, 0.2)',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4.03 3 9 3s9-1.34 9-3"/></svg>,
    skills: ['PostgreSQL', 'Supabase'],
  },
  {
    label: 'Tools',
    color: '#818CF8', bg: 'rgba(129, 140, 248, 0.1)', border: 'rgba(129, 140, 248, 0.25)',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>,
    skills: ['Git', 'GitHub', 'Postman', 'VS Code'],
  },
  {
    label: 'Cloud & Deployment',
    color: '#60A5FA', bg: 'rgba(96, 165, 250, 0.1)', border: 'rgba(96, 165, 250, 0.2)',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>,
    skills: ['Cloudflare Pages', 'Render'],
  },
  {
    label: 'Integrations',
    color: '#F472B6', bg: 'rgba(244, 114, 182, 0.1)', border: 'rgba(244, 114, 182, 0.2)',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>,
    ...
    <section id="skills" style={{ background: 'var(--bg)' }}>
      <div className="container">
        ...
        >
          ...
          <p className="section-subtitle">Tools and technologies I use to build full-stack products from idea to production.</p>
        </motion.div>
        ...
        >
          {categories.map((cat) => (
            <motion.div
              ...
              className="card"
              style={{ padding: '28px 24px', background: 'var(--bg-card)' }}
            >
              {/* Category Header */}
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '0.95rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--text-1)' }}>{cat.label}</span>
              </div>
